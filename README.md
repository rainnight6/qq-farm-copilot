...
- 原项目地址：`https://github.com/megumiss/qq-farm-copilot`
...
- [x] 一键收获 / 务农
- [x] 自动购买种子
- [x] 自动播种（不会支持四格，占用四格土地收益太低，建议手动有机肥料速刷）
- [x] 自动施肥（通过作物剩余成熟时间判断后自动施肥并收获，需开启地块巡查）
- [x] 自动扩建土地
- [x] 自动升级土地
- [x] 仓库批量出售
- [x] 任务奖励领取
...
- [x] 一键启动
- [x] 异常发送通知
- [x] 异常自动重启（QQ端可以选择优先修复重启）
- [x] 定时重启窗口（也可修复重启）
- [x] 支持QQ/微信平台后台运行
- [x] 支持QQ/微信平台多开
- [x] 通用活动（活动更新后适配，过时自动关闭）ps.一次性领取活动不作适配（如6.19粽叶活动）
- [x] 自动种草
